      ...
      <main className="flex-1 flex flex-col items-center w-full">
        ...
        <div className="w-full px-4 py-20 max-w-[1200px]">
          <div className="flex flex-col gap-10 md:gap-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex flex-col gap-4 rounded-xl border border-border-dark bg-surface-dark p-6">
        ...
        <div className="w-full bg-surface-dark border-y border-border-dark py-20">
          <div className="max-w-[1200px] mx-auto px-4 flex flex-col gap-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex flex-col overflow-hidden rounded-xl border border-border-dark bg-surface-dark">
