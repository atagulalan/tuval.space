...
import { getModificationCount, toggleModificationEnabled, decodePixelsFromBase36 } from '@/services/modification.service';
...
export const ModificationEntry: React.FC<ModificationEntryProps> = ({
  ...
  const isBoardOwner = currentUserId && boardOwnerId && currentUserId === boardOwnerId;
  ...
  useEffect(() => {
    ...
    const scale = Math.min(availableSize / modification.w, availableSize / modification.h, 1);
        ...
        <div className="flex items-start gap-2 flex-1">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground">
              Region: ({modification.x}, {modification.y}) {modification.w}×{modification.h}
            </p>
            <p className="text-xs text-muted-foreground">
        ...
        <div className="flex items-start gap-2 flex-shrink-0">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <Button
              ...
              disabled={isToggling}
              title={modification.enabled ? 'Disable modification' : 'Enable modification'}
            >
              {modification.enabled ? (
