...
import { getErrorCode, getErrorMessage, FIREBASE_ERROR_CODES } from '@/types/errors';
    ...
    try {
      ...
      if (errorCode === FIREBASE_ERROR_CODES.POPUP_CLOSED) {
        toast({
          ...
          description: 'The sign-in popup was closed. Please try again if you want to sign in.',
          variant: 'default',
        });
      } else {
        logError('Login Failed', errorMessage, 'LoginButton', { error_code: errorCode });
        toast({
          title: 'Login failed',
