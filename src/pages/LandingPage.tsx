...
import { LandingPageSkeleton } from '@/components/Loading';
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-background-dark text-white font-['Space_Grotesk',sans-serif] overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col items-center w-full">
            ...
            <div className="flex flex-col gap-6 lg:w-1/2 justify-center">
              <div className="flex flex-col gap-4 text-left">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
                  {user ? 'Welcome back!' : 'Create Together on Shared Canvases'}
                </h1>
              ...
              {!user && (
                <div className="flex items-center gap-3 pt-4 opacity-80">
                  <p className="text-sm font-medium text-slate-400">Join 12,000+ artists online</p>
                </div>
              )}
            </div>
            {/* Hero Visual */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex flex-col gap-1 p-4 rounded-lg border border-transparent hover:border-border-dark transition-all">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-slate-400 text-sm font-medium">Pixels Placed</p>
                </div>
                <p className="text-3xl font-bold leading-tight">{stats.pixelsPlaced.value}</p>
                <p className="text-green-500 text-sm font-medium flex items-center gap-1">
                  <span className="material-symbols-outlined text-sm">trending_up</span> {stats.pixelsPlaced.trend}
                </p>
              </div>
              <div className="flex flex-col gap-1 p-4 rounded-lg border border-transparent hover:border-border-dark transition-all">
                <div className="flex items-center gap-2 mb-2">
                  <span className="material-symbols-outlined text-primary">groups</span>
                  <p className="text-slate-400 text-sm font-medium">Active Artists</p>
                </div>
                <p className="text-3xl font-bold leading-tight">{stats.activeArtists.value}</p>
                <p className="text-green-500 text-sm font-medium flex items-center gap-1">
                  <span className="material-symbols-outlined text-sm">person_add</span> {stats.activeArtists.trend}
                </p>
              </div>
              <div className="flex flex-col gap-1 p-4 rounded-lg border border-transparent hover:border-border-dark transition-all">
                <div className="flex items-center gap-2 mb-2">
                  <span className="material-symbols-outlined text-primary">palette</span>
                  <p className="text-slate-400 text-sm font-medium">Total Canvases</p>
                </div>
                <p className="text-3xl font-bold leading-tight">{stats.totalCanvases.value}</p>
                <p className="text-green-500 text-sm font-medium flex items-center gap-1">
                  <span className="material-symbols-outlined text-sm">add_circle</span> {stats.totalCanvases.trend}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-10 md:gap-16">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
              <div className="flex flex-col gap-4 max-w-[600px]">
                <h2 className="text-3xl md:text-4xl font-bold leading-tight tracking-tight">How It Works</h2>
                <p className="text-slate-300 text-lg leading-relaxed">
                  Experience a unique blend of creativity and strategy. Canvases are shared, but your pixels are precious.
                </p>
              </div>
              <a className="text-primary font-bold flex items-center gap-1 hover:gap-2 transition-all" href="#gameplay">
                Learn more about gameplay <span className="material-symbols-outlined text-sm">arrow_forward</span>
              </a>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Feature 1 */}
              <div className="flex flex-col gap-4 rounded-xl border border-border-dark bg-surface-dark p-6 hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-xl font-bold leading-tight">Real-time Collaboration</h3>
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Watch the canvas evolve live as users place pixels simultaneously from around the globe. No refreshing needed.
                  </p>
                </div>
              </div>
              {/* Feature 2 */}
              <div className="flex flex-col gap-4 rounded-xl border border-border-dark bg-surface-dark p-6 hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-xl font-bold leading-tight">Daily Pixel Allowance</h3>
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Strategic placement matters. Your pixels regenerate over time, making every placement a tactical decision.
                  </p>
                </div>
              </div>
              {/* Feature 3 */}
              <div className="flex flex-col gap-4 rounded-xl border border-border-dark bg-surface-dark p-6 hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-xl font-bold leading-tight">Multiple Boards</h3>
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Create and explore multiple shared canvases. Each board is a unique space for collaborative art.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Gameplay Section */}
        <div id="gameplay" className="w-full bg-surface-dark border-y border-border-dark py-20">
          <div className="max-w-[1200px] mx-auto px-4 flex flex-col gap-12">
            <div className="flex flex-col items-center text-center gap-4">
              <h2 className="text-3xl md:text-4xl font-bold leading-tight tracking-tight">Gameplay Guide</h2>
              <p className="text-slate-400 max-w-[700px] text-lg">
                Master the art of collaborative pixel placement. Learn how to make the most of your daily quota and create stunning artworks together.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col gap-6 rounded-xl border border-border-dark bg-background-dark p-8">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-2xl font-bold leading-tight">Pixel Quota System</h3>
                </div>
                <div className="flex flex-col gap-4 text-slate-400">
                  <p className="leading-relaxed">
                    Every user receives a daily allocation of pixels to place on shared canvases. This quota system ensures fair participation and adds strategic depth to your creative decisions.
                  </p>
                  <ul className="flex flex-col gap-3 list-none">
                    ...
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">check_circle</span>
                      <span>Each pixel placement consumes one from your quota</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">check_circle</span>
                      <span>Plan your placements strategically - pixels are limited!</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6 rounded-xl border border-border-dark bg-background-dark p-8">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-2xl font-bold leading-tight">Real-time Collaboration</h3>
                </div>
                <div className="flex flex-col gap-4 text-slate-400">
                  <p className="leading-relaxed">
                    Work alongside other artists in real-time. See pixels appear instantly as they're placed, creating a dynamic and interactive creative experience.
                  </p>
                  <ul className="flex flex-col gap-3 list-none">
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">check_circle</span>
                      <span>Watch the canvas evolve live without refreshing</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">check_circle</span>
                      <span>Coordinate with others to create larger artworks</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">check_circle</span>
                      <span>View modification history to see how art evolves</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6 rounded-xl border border-border-dark bg-background-dark p-8">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-2xl font-bold leading-tight">Strategy Tips</h3>
                </div>
                <div className="flex flex-col gap-4 text-slate-400">
                  <p className="leading-relaxed">
                    Make every pixel count with these strategic approaches to collaborative art creation.
                  </p>
                  <ul className="flex flex-col gap-3 list-none">
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">tips_and_updates</span>
                      <span>Start with an outline before filling in details</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">tips_and_updates</span>
                      <span>Communicate with other artists for coordinated designs</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">tips_and_updates</span>
                      <span>Save pixels for important details and finishing touches</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6 rounded-xl border border-border-dark bg-background-dark p-8">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-2xl font-bold leading-tight">Board Features</h3>
                </div>
                <div className="flex flex-col gap-4 text-slate-400">
                  <p className="leading-relaxed">
                    Explore the full range of features available on each canvas to enhance your creative experience.
                  </p>
                  <ul className="flex flex-col gap-3 list-none">
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">palette</span>
                      <span>Full color palette with precise color selection</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">history</span>
                      <span>View complete modification history and timeline</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="material-symbols-outlined text-primary text-xl mt-0.5">zoom_in</span>
            ...
            <div className="flex flex-col items-center gap-6 pt-8">
              <h3 className="text-2xl font-bold text-center">Ready to Start Creating?</h3>
              <p className="text-slate-400 text-center max-w-[600px]">
                Join thousands of artists and start placing your first pixels today. Every masterpiece begins with a single pixel.
              </p>
        ...
        <div className="w-full bg-gradient-to-b from-slate-900 to-surface-dark border-y border-border-dark py-20">
          <div className="max-w-[1200px] mx-auto px-4 flex flex-col gap-12">
            <div className="flex flex-col items-center text-center gap-4">
              <h2 className="text-3xl md:text-4xl font-bold leading-tight tracking-tight bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">Community Masterpieces</h2>
              <p className="text-slate-400 max-w-[600px]">
                Check out some of the most impressive collaborative artworks completed by our community this month.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-5 flex flex-col gap-3 bg-slate-900">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs font-mono bg-primary/20 text-primary px-2 py-1 rounded">{card.pixels}</span>
                    </div>
        ...
        {!user && (
          <div className="w-full px-4 py-24 max-w-[800px] text-center">
            <div className="flex flex-col items-center gap-8">
              <h2 className="text-4xl md:text-5xl font-black leading-tight tracking-tight">Ready to leave your mark?</h2>
              <p className="text-slate-300 text-lg leading-relaxed max-w-[600px]">
                The canvas is waiting. Login now to claim your first set of pixels and start creating with the community.
              </p>
        ...
        <div className="max-w-[1200px] mx-auto px-4 flex flex-col gap-10">
          <div className="flex flex-col md:flex-row justify-between gap-10">
            <div className="flex flex-col gap-4 max-w-[300px]">
              <div className="flex items-center gap-2 text-white">
                <img src="/logo.svg" alt="tuval.space logo" className="w-8 h-8" />
                <span className="text-xl font-bold">tuval.space</span>
              </div>
              <p className="text-slate-400 text-sm">
                A collaborative canvas where you can have fun with others or use as your personal creative space. Create together, one pixel at a time.
              </p>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-10 sm:gap-16">
              <div className="flex flex-col gap-3">
                <h4 className="font-bold text-white">Platform</h4>
                <a className="text-slate-400 hover:text-primary text-sm" href="#canvas">
                  Canvas
                </a>
                <a className="text-slate-400 hover:text-primary text-sm" href="#leaderboard">
                  Leaderboard
                </a>
                <a className="text-slate-400 hover:text-primary text-sm" href="#factions">
                  Factions
                </a>
              </div>
              <div className="flex flex-col gap-3">
                <h4 className="font-bold text-white">Community</h4>
                <a className="text-slate-400 hover:text-primary text-sm" href="#discord">
                  Discord
                </a>
                <a className="text-slate-400 hover:text-primary text-sm" href="#reddit">
                  Reddit
                </a>
              </div>
              <div className="flex flex-col gap-3">
                <h4 className="font-bold text-white">Legal</h4>
                <a className="text-slate-400 hover:text-primary text-sm" href="#terms">
                  Terms
                </a>
                <a className="text-slate-400 hover:text-primary text-sm" href="#privacy">
                  Privacy
                </a>
                <a className="text-slate-400 hover:text-primary text-sm" href="#guidelines">
                  Guidelines
                </a>
              </div>
            </div>
          ...
          <div className="pt-8 border-t border-border-dark flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-slate-600">
            ...
            <div className="flex gap-4">
              <a className="hover:text-primary transition-colors" href="https://github.com/atagulalan/tuval.space" target="_blank" rel="noopener noreferrer">
